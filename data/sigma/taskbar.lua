...
infocentersingleobserver = function( id )
	...
	BindLabelToPlayerRenew	( "",		"", 2,	LocalPlayer() )
		BindHudToTooltip		( "",		"", 1, 2 )

	BindLabelToPlayerGather	( "",		"", 1,	LocalPlayer() )
		BindHudToTooltip		( "",		"", 1, 1 )
		
	BindLabelToPlayerPop	( "",		"", 3,	LocalPlayer() )
		BindHudToTooltip		( "",		"", 1, 3 )
